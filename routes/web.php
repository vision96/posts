...
Route::group(['prefix'=>'admin','middleware'=>'auth'],function(){
    Route::get('/dashboard', [App\Http\Controllers\Admin\AdminController::class, 'index'])->name('dashboard');
        ...
        Route::resource('post','App\Http\Controllers\Admin\PosttController');
        Route::post('/publishPost/{id}', [App\Http\Controllers\Admin\PosttController::class, 'publishPost'])->name('publishPost');

        Route::resource('category','App\Http\Controllers\Admin\CategoryyController');
