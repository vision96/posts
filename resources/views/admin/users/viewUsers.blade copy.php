                ...
                <div class="col-md-12 form-group">
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" name="image" class="custom-file-input" id="fileupload3">
                      <label class="custom-file-label" for="fileupload3" id="filename3">Choose image</label>
                    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <img class="img-fluid img-bordered" id="image" src="" onerror="this.src='/images/default.png';">
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="image" class="custom-file-input" id="fileupload2">
                        <label class="custom-file-label" for="fileupload2" id="filename2">Choose image</label>
                      </div>
                    </div>
                  </div>
